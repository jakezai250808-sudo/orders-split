  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: 'orders/:id/approve', meta: { title: '审批流' }, component: () => import('@/views/orders/OrderApprove.vue') },
        { path: 'orders/:id/deliverables', meta: { title: '交付件管理' }, component: () => import('@/views/orders/OrderDeliverables.vue') },
